 ...
 *
 * This version of the messaging resource does not block when POSTing a new
 * message.
 *
...
public class FireAndForgetChatResource {
	...
	private static final ExecutorService QUEUE_EXECUTOR = Executors
			.newCachedThreadPool(new ThreadFactoryBuilder().setNameFormat("fire&forget-chat-resource-executor-%d")
	...
	static {
		PropertyConfigurator
				.configure(FireAndForgetChatResource.class.getClassLoader().getResource("log4j.properties"));
	}
